              ...
              {isFromRegisterCase && (
                <div className="mt-4 p-4 rounded-lg bg-amber-50 border border-amber-200 dark:bg-amber-950/20 dark:border-amber-800">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="text-sm font-medium text-amber-800 dark:text-amber-200">Complete your profile to report missing persons</h3>
                      <p className="mt-1 text-sm text-amber-700 dark:text-amber-300">Please complete your profile setup to access the missing person reporting form. This helps us verify your identity and provide better case matching.</p>
                    </div>
                  </div>
                </div>
              )}
